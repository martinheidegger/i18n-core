...
function _____n (translate, translateFirst, singular, plural, count, namedValues, args) {
  var keys
  var fallbackKey
  if (count > 1) {
  ...
  return translateFirst(keys, fallbackKey, namedValues, args)
}

function ____n (translate, translateFirst, singular, plural, count, namedValues, a, b, c, d, e, f, g, h, i, j) {
  var args
  if (j !== undefined) {
  ...
  return _____n(translate, translateFirst, singular || plural, plural || singular, count, namedValues, args)
}

function ___n (translate, translateFirst, singular, plural, count, namedValues, a, b, c, d, e, f, g, h, i, j) {
  if (typeof namedValues === 'object' && namedValues !== null) {
    return ____n(translate, translateFirst, singular, plural, count, namedValues, a, b, c, d, e, f, g, h, i, j)
  }
  return ____n(translate, translateFirst, singular, plural, count, {}, namedValues, a, b, c, d, e, f, g, h, i)
}
...
module.exports = function createTranslator (prefix, parent, allowModification) {
  ...
  __.__n = function __n (singular, plural, count, namedValues, a, b, c, d, e, f, g, h, i, j) {
    if (typeof plural !== 'object' && typeof plural !== 'string') {
      return ___n(__.translate, __.translateFirst, singular, singular, plural, count, namedValues, a, b, c, d, e, f, g, h, i)
    }
    return ___n(__.translate, __.translateFirst, singular, plural, count, namedValues, a, b, c, d, e, f, g, h, i, j)
  }
